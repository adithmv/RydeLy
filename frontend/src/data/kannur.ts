...
export const KANNUR_STANDS: Stand[] = [
  ...
  { id: "tlp-chemperi-busstand",       name: "Chemperi Bus Stand Auto Stand",       town: "Chemperi",        taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-vjec-gate",      name: "Vimal Jyothi Engineering College (VJEC Gate) Auto Stand", town: "Chemperi", taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-jyothinagar",    name: "Jyothi Nagar (VJEC Campus) Auto Stand", town: "Chemperi",      taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-vjec-lh",        name: "Vimal Jyothi Ladies Hostel Junction Auto Stand", town: "Chemperi", taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-vjec-bh",        name: "Vimal Jyothi Sanjo Boys Hostel Auto Stand", town: "Chemperi",   taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-church",         name: "Lourdes Forane Church Chemperi Auto Stand", town: "Chemperi",  taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-nirmala",        name: "Nirmala HSS Chemperi Auto Stand",      town: "Chemperi",        taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-hospital",       name: "St. Martin's Hospital Chemperi Auto Stand", town: "Chemperi",   taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-kozhichal",      name: "Chemperi Kozhichal Road Auto Stand",   town: "Chemperi",        taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-eruvessi-bridge", name: "Chemperi-Eruvessi Bridge Auto Stand", town: "Chemperi",       taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-pooparamba",     name: "Pooparamba Auto Stand",                town: "Chemperi",        taluk: "Taliparamba", district: "Kannur" },
  { id: "tlp-chemperi-manippara",      name: "Manippara Auto Stand",                 town: "Chemperi",        taluk: "Taliparamba", district: "Kannur" },
