...
export default function StandsList({ onSelect, onClose }: StandsListProps) {
  ...
  return (
    <div className="stands-list-modal">
      {/* Header */}
      <div className="stands-list-header">
        <h2 className="font-heading text-lg font-bold">Select Pickup Stand</h2>
        <button 
          className="live-link" 
          onClick={onClose}
