...
class Config:
    ...
    DRIVER_RADIUS_KM = float(os.getenv("DRIVER_RADIUS_KM", "30"))
    # Broadcast matching settings (Phase 5)
    BROADCAST_RADIUS_KM = float(os.getenv("RIDE_BROADCAST_RADIUS_KM", "20"))
    BROADCAST_EXPANSION_RADIUS_KM = float(os.getenv("RIDE_BROADCAST_RADIUS_EXPANDED_KM", "35"))
